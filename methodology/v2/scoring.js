/**
 * SCORING LOGIC v2 — the canonical copy.
 *
 ...
 *
 * v2 moves 15 points into false-positive resistance, taking 10 from AI recall
 * and 5 from human specificity. The reasoning is the one this benchmark was
 * built on: the two error types are not symmetric in consequence, and the
 * corpus that measures the costlier error deserves the larger share. Under v1
 * it carried 20 points while catching machines carried 30, which sat awkwardly
 * against the stated rationale.
 *
 * The change was decided after cycle 2026-08 was scored, not before it opened.
 * CHANGES.md records that, and both the v1 and v2 tables, because a weighting
 * chosen with the results already visible is a weaker thing than one fixed in
 * advance and a reader is entitled to weigh it accordingly.
 */
